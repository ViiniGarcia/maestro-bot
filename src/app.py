...
@app_commands.choices(game_map=[
    ...
    app_commands.Choice(name="Universidade Bartlett",
                        value="Universidade Bartlett"),
...
async def tatics(interaction: discord.Interaction, url: str,
                 game_map: app_commands.Choice[str],
                 phase: app_commands.Choice[str],
                 bomb: app_commands.Choice[str], operators: str):
